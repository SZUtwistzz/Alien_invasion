...
class AlienInvasion:
    ...
    def _load_sounds(self):
        ...
        try:
            # You can use .wav or .ogg files
            self.bullet_sound = pygame.mixer.Sound('sounds/bullet.wav')
            self.alien_sound = pygame.mixer.Sound('sounds/explosion.wav')
    ...
    def _check_alien_fire(self):
        """Check if any alien should fire a bullet."""
        if not self.aliens:
            return
            
        # Check if we should fire based on probability
        if random.random() < self.settings.alien_fire_probability * len(self.aliens):
    ...
    def _fire_alien_bullet(self, alien):
        """Fire a bullet from a specific alien."""
        new_bullet = Bullet(self, alien)
        self.alien_bullets.add(new_bullet)
        # Optional: Play sound for alien shot (maybe different sound or same)
        # if self.bullet_sound:
        #    self.bullet_sound.play()
